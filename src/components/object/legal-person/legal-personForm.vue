    ...
    <div class="content">
        ...
        >
            ...
            <a-form-model-item label="经营地址经度" prop="经营地址经度">
                <a-input-number :max="180" v-model="form.经营地址经度" style="width:100%" />
            </a-form-model-item>

            <a-form-model-item label="经营地址纬度" prop="经营地址纬度">
                <a-input-number :max="180" v-model="form.经营地址纬度" style="width:100%" />
            </a-form-model-item>
...
export default {
    ...
    methods: {
        ...
        closeModal() {
            this.$root.$emit("updataCLoseOrganization", "close关闭modal");
        },
