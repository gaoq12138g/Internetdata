    ...
    <div class="content">
        ...
        >
            ...
            <a-form-model-item
                ...
                prop="许可项目"
            >
                <a-textarea v-model="form['许可项目']" :rows="1" />
            </a-form-model-item>
            ...
            <a-form-model-item
                ...
                prop="生产企业地址"
            >
                <a-textarea v-model="form['生产企业地址']" :rows="1" />
            </a-form-model-item>
            ...
            <a-form-model-item label="企业所在省" prop="企业所在省">
                <a-input v-model="form.企业所在省" />
            </a-form-model-item>

            <a-form-model-item label="企业所在市" prop="企业所在市">
                <a-input v-model="form.企业所在市" />
            </a-form-model-item>

            <a-form-model-item label="法人代表" prop="法人代表">
                <a-input v-model="form.法人代表" />
            </a-form-model-item>
...
export default {
    ...
    methods: {
        ...
        add() {
            this.axios
                .post("special/cosmetic/insert", this.data)
                .then((res) => {
                    console.log(res);
        ...
        update() {
            this.axios
                .post("special/cosmetic/update", this.data[0])
                .then((res) => {
                    console.log(res);
                    if (res.data.code == 200) {
