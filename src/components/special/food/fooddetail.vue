<template>
    <div class="content">
        ...
        >
            ...
            >
                <div>{{ form.所使用的食品添加剂在国家标准中的通用名称 }}</div>
            </a-form-model-item>
            ...
            <a-form-model-item label="生产企业行政区划代码" prop="生产企业行政区划代码" ref="xzqhdm">
