...
import legalPersonForm from "../../../components/object/legal-person/legal-personForm.vue";
import legalPersondetail from "../../../components/object/legal-person/legal-persondetail.vue";
...
export default {
    ...
    methods: {
        ...
        // 组件内触发关闭弹窗
        closeModel() {
            this.$root.$on("updataCLoseOrganization", (msg) => {
                this.handleOk();
            });
        },
        ...
        // 删除
        delete(id) {
            this.axios.get("object/organization/delete/" + id).then((res) => {
                console.log(res);
                if ((res.data.code = 200)) {
