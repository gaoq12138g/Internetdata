<template>
    <div class="content">
        ...
        >
            <cosmeticFrom v-if="visible && types != 'detail'" :item="selectedItem" :types="types" />
            <medicinedetail
...
import cosmeticFrom from "@/components/special/cosmetic/cosmeticFrom.vue";
import medicinedetail from "@/components/special/cosmetic/cosmeticdetail.vue";
...
export default {
    ...
    methods: {
        ...
        // 组件内触发关闭弹窗
        closeModel() {
            this.$root.$on("updataCLoseCosmetic", (msg) => {
                this.handleOk();
            });
        },
        ...
        query() {
            this.axios
                .post("special/cosmetic/query", this.condition)
                .then((res) => {
                    console.log(res);
        ...
        // 删除
        delete(id) {
            this.axios.get("special/cosmetic/delete/" + id).then((res) => {
                console.log(res);
                if ((res.data.code = 200)) {
        ...
        handleChange: function (a) {
            ...
            importExcel(a.file).then((data) => {
                ...
                let result = verify.verify(_this.importData, "化妆品");
                console.log(result);
        ...
        handleUpload: function () {
            this.axios
                .post("special/cosmetic/insert", this.importData)
                .then((res) => {
                    console.log(res);
                    if (res.data.code == 200) {
