<template>
    <div class="content">
        ...
        >
            <instrumentForm v-if="visible && types != 'detail'" :item="selectedItem" :types="types" />
            <detailInstrumentForm v-if="types == 'detail'" :item="selectedItem" :types="types" />
        </a-modal>
...
import instrumentForm from '@/components/special/medical-instruments/instrumentForm.vue'
import detailInstrumentForm from '@/components/special/medical-instruments/detailInstrumentForm.vue'
...
export default {
    ...
    methods: {
        ...
        // 组件内触发关闭弹窗
        closeModel() {
            this.$root.$on("updataCLoseInstrument", (msg) => {
                this.handleOk();
            });
        },
        ...
        query() {
            this.axios
                .post("special/instrument/query", this.condition)
                .then((res) => {
                    console.log(res);
        ...
        // 删除
        delete(id) {
            this.axios.get("special/instrument/delete/" + id).then((res) => {
                console.log(res);
                if ((res.data.code = 200)) {
        ...
        handleChange: function (a) {
            ...
            importExcel(a.file).then((data) => {
                ...
                let result = verify.verify(_this.importData, "医疗器械");
                console.log(result);
        ...
        handleUpload: function () {
            this.axios
                .post("special/instrument/insert", this.importData)
                .then((res) => {
                    console.log(res);
                    if (res.data.code == 200) {
