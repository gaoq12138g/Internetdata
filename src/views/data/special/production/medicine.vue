<template>
    <div class="content">
        ...
        >
            <medicineFrom v-if="visible && types != 'detail'" :item="selectedItem" :types="types" />
            <medicinedetail
...
import medicineFrom from "@/components/special/medicine/medicineFrom.vue";
import medicinedetail from "@/components/special/medicine/medicinedetail.vue";
...
export default {
    ...
    methods: {
        ...
        // 组件内触发关闭弹窗
        closeModel() {
            this.$root.$on("updataCLoseMedicine", (msg) => {
                this.handleOk();
            });
        },
        ...
        query() {
            this.axios
                .post("special/medicine/query", this.condition)
                .then((res) => {
                    console.log(res);
        ...
        // 删除
        delete(id) {
            this.axios.get("special/medicine/delete/" + id).then((res) => {
                console.log(res);
                if ((res.data.code = 200)) {
        ...
        handleChange: function (a) {
            ...
            importExcel(a.file).then((data) => {
                ...
                let result = verify.verify(_this.importData, "药品");
                console.log(result);
        ...
        handleUpload: function () {
            this.axios
                .post("special/medicine/insert", this.importData)
                .then((res) => {
                    console.log(res);
                    if (res.data.code == 200) {
